...
class Settings(BaseSettings):
    ...
    image_detail: str = Field(default="high", pattern="^(low|high|auto)$")
    document_max_bytes: int = Field(default=20_000_000, ge=100_000, le=50_000_000)
    document_max_characters: int = Field(default=100_000, ge=1_000, le=1_000_000)
    document_processing_timeout_seconds: int = Field(default=30, ge=5, le=120)
