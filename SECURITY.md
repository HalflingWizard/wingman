...
These notes apply to Wingman 5.10.0.
...
Unified saved-context search is read-only and owner-scoped. It searches memories, places, ideas, events, and reminders without preloading the database into prompts. Memory and planning writes are validated and audited. The active agent saves useful durable details directly, while deletion remains under explicit owner controls. Planning tools check ownership, linked records, duplicate names and dates, and required event times.
